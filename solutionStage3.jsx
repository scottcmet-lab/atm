...
const Account = () => {
  ...
  const handleModeSelect = (event) => {
    ...
    if (event.target.value != "") { setIsDeposit(event.target.value == "Deposit") }
    event.preventDefault();
  }
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {
        atmMode != "" && <ATMDeposit onChange={handleChange} isDeposit={isDeposit} isValid={validTransaction}> Deposit</ATMDeposit>
      }
    </form>
  );
};// ========================================
